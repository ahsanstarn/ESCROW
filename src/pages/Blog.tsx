...
export default function Blog() {
  const posts = [
    { title:'The Future of Escro: Trends to Watch in 2026', date:'Jun 2, 2026', cat:'Industry', excerpt:'Explore the emerging trends shaping the escro industry and how technology is transforming secure transactions.' },
    { title:'How Escro Protects Freelancers and Clients', date:'May 28, 2026', cat:'Guides', excerpt:'A comprehensive guide on how escro services create a safety net for both freelancers and their clients.' },
    { title:'Understanding Cross-Border Escro Transactions', date:'May 20, 2026', cat:'Business', excerpt:'Navigate the complexities of international escro with our expert guide on cross-border payments.' },
    { title:'5 Ways Escro Reduces eCommerce Fraud', date:'May 15, 2026', cat:'Security', excerpt:'Learn how implementing escro can dramatically reduce fraud risks in your online business.' },
    { title:'Escro for SaaS Subscriptions: A New Standard', date:'May 8, 2026', cat:'Product', excerpt:'Why subscription businesses are adopting escro to build trust and reduce churn.' },
    { title:'The Rise of Milestone-Based Escro Payments', date:'Apr 30, 2026', cat:'Product', excerpt:'How milestone payments are revolutionizing project-based work across industries.' },
  ];

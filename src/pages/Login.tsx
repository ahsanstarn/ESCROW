      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-lg text-slate-400">
            Build trust in every transaction. Secure escrow for buyers and sellers worldwide.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-slate-600">
                <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-brand-400 focus:ring-brand-400" />
                Remember me
              </label>

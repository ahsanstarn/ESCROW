...
export function Privacy() {
  return (
    <Page title="Privacy Policy">
      ...
      <p className="mb-6">Escrow is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information.</p>
      ...
      <h2 className="text-lg font-bold mb-3">How We Use Information</h2>
...
export function Terms() {
  return (
    <Page title="Terms of Service">
      <p className="mb-4"><strong>Last Updated:</strong> January 1, 2026</p>
      <p className="mb-6">By using Escrow's services, you agree to these Terms of Service. Please read them carefully.</p>
      <h2 className="text-lg font-bold mb-3">1. Account Registration</h2>
      ...
      <h2 className="text-lg font-bold mb-3">2. Escrow Services</h2>
      <p className="mb-6">Escrow holds funds in trust accounts. Funds are released only when all conditions of the transaction are met as agreed by both parties.</p>
      <h2 className="text-lg font-bold mb-3">3. Fees</h2>
      ...
      <h2 className="text-lg font-bold mb-3">4. Disputes</h2>
      <p className="mb-6">In case of disputes, Escrow will review evidence from both parties and make a binding resolution. Disputes must be filed within the confirmation window.</p>
      <h2 className="text-lg font-bold mb-3">5. Limitation of Liability</h2>
      <p>Escrow's liability is limited to the amount held in escrow for the specific transaction. We are not liable for indirect or consequential damages.</p>
    </Page>
  );
}

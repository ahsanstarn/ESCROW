...
export function CountdownTimer({ targetDate, label }: CountdownTimerProps) {
  ...
  return (
    <div className="card p-4 bg-escrow-600/5 border-escrow-600/15">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Clock className="w-5 h-5 text-escrow-400 flex-shrink-0" />
          <div>
        ...
        <div className="flex items-center gap-3">
          <div className="text-center">
            <div className="text-xl font-mono font-semibold text-escrow-400 tabular-nums">
